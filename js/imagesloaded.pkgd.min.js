...
!function (a, b) {
    ...
    return b.on = function (c, g) {
        if (c && g) {
            var d = this._events = this._events || {}, f = d[c] = d[c] || [];
            return f.indexOf(g) == -1 && f.push(g), this
        }
    }, b.once = function (c, g) {
        if (c && g) {
            this.on(c, g);
            var d = this._onceEvents = this._onceEvents || {}, f = d[c] = d[c] || {};
            return f[g] = !0, this
        }
    }, b.off = function (c, g) {
    ...
    function l(a, i, d) {
        ...
        var h = a;
        return "string" == typeof a && (h = document.querySelectorAll(a)), h ? (this.elements = k(h), this.options = j({}, this.options), "function" == typeof i ? d = i : j(this.options, i), d && this.on("always", d), this.getImages(), g && (this.jqDeferred = new g.Deferred), void setTimeout(this.check.bind(this))) : void b.error("Bad element for imagesLoaded " + (h || a))
    }
    ...
    var g = f.jQuery, b = f.console, c = Array.prototype.slice;
    ...
    return l.prototype.addElementBackgroundImages = function (a) {
        ...
        this.progressedCount++, this.hasAnyBroken = this.hasAnyBroken || !a.isLoaded, this.emitEvent("progress", [this, a, h]), this.jqDeferred && this.jqDeferred.notify && this.jqDeferred.notify(this, a), this.progressedCount == this.images.length && this.complete(), this.options.debug && b && b.log("progress: " + d, a, h)
